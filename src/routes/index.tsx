      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        <Reveal delay={400}>
          ...
          <p className="mt-3 max-w-2xl text-sm font-light text-pearl/80 md:text-base">
            Primeiro lote · 20 unidades · Em breve
          </p>
        </Reveal>
...
function FAQ() {
  const faqs = [
    ...
    { q: "Como funciona a pré-venda?", a: "Você realiza o pagamento agora e recebe o produto assim que o primeiro lote for entregue. Envio previsto: Em breve." },
